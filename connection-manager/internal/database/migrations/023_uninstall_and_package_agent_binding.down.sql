-- Revert command-type allowlist and drop per-agent binding columns.
...
DROP INDEX IF EXISTS idx_agent_packages_agent_id;
ALTER TABLE agent_packages DROP COLUMN IF EXISTS agent_id;
ALTER TABLE agent_packages DROP COLUMN IF EXISTS consumed_at;
