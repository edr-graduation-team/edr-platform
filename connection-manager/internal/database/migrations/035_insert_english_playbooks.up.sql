-- Migration: Insert English Playbooks
-- Description: Inserts the 3 default English playbooks and rules that the UI expects.
...
('44444444-4444-4444-4444-444444444444', 
 ...
 'Triggers the Ransomware Containment Playbook when highly suspicious encryption behavior (e.g. vssadmin deletion + mass file rename) is detected on any agent.', 
...
('55555555-5555-5555-5555-555555555555', 
 ...
 'Triggers the USB response playbook to unmount unknown devices immediately upon detection of the hardware insertion event.', 
...
('66666666-6666-6666-6666-666666666666', 
 ...
 'Terminates known credential dumping utilities (e.g. Mimikatz, Procdump against LSASS) and triggers an advanced memory scan playbook.', 
