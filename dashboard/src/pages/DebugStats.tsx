            ...
            {open && (
                <div className="border-t border-gray-200 dark:border-gray-700 p-4 space-y-4 bg-gray-50/50 dark:bg-gray-900/30">
                    ...
                    <Block title="Formula / explanation">
                        <div className="whitespace-pre-wrap text-sm leading-relaxed text-gray-800 dark:text-gray-200 p-2" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
                            {section.formula}
                        </div>
                    </Block>
                                ...
                                <li key={i} className="border-l-2 border-primary-400 pl-3">
                                    ...
                                    {st.note && (
                                        <div className="mt-2 text-xs text-gray-600 dark:text-gray-400 font-medium">
                                            note: <span className="italic">{st.note}</span>
                                        </div>
                                    )}
                                </li>
                            ))}
...
function KV({ label, value }: { label: string; value: unknown }) {
    return (
        <div className="mt-2 text-left">
            <span className="text-xs font-semibold text-gray-600 dark:text-gray-400 mr-2">{label}:</span>
